...
banco_palabras = {
    "es": {
        5: (
            "razón", "árbol", "barco", "botón", "carta", "cielo", "claro", "coche", "cobre", "crema",
            "cuota", "dardo", "denso", "dieta", "digno", "donde", "duelo", "dulce", "echar", "enano",
            "enero", "época", "ética", "etnia", "fresa", "fruta", "gesto", "grupo", "huevo", "joven",
            "juego", "jamón", "lente", "libro", "logro", "madre", "padre", "plaza", "playa", "pobre",
            "poder", "radio", "reloj", "ruido", "salud", "salón", "cerca", "leche", "tarde", "verde"
        ),
        6: (
            "imagen", "entero", "camino", "planta", "amigos", "título", "diente", "escena", "cuerpo", "médico",
            "código", "acción", "tardes", "herida", "paleta", "sábana", "teatro", "motivo", "viajar", "viajes",
            "viejos", "jueces", "cantar", "correr", "cortar", "cocina", "cosido", "cuadro", "dorado", "franco",
            "grande", "lácteo", "latido", "mancha", "marino", "marcos", "marrón", "mentir", "mesada", "mezcla",
            "nervio", "origen", "pájaro", "papaya", "patria", "pecado", "pelota", "pereza", "pesado", "tomate"
        ),
        7: (
            "domingo", "mensaje", "caminar", "trabajo", "mercado", "escuela", "ventana", "paredes", "carrera", "bosques",
            "pueblos", "maqueta", "planeta", "sistema", "usuario", "verdura", "carpeta", "archivo", "bandera", "barbero",
            "barista", "batería", "caballo", "cabello", "cálculo", "cámaras", "canción", "caracol", "cartera", "casitas",
            "cerebro", "cultura", "derecho", "deseado", "diálogo", "enfermo", "ensayos", "espacio", "estudio", "familia",
            "feriado", "fiestas", "formato", "frutero", "gaviota", "géneros", "hogares", "juguete", "lectura", "leyenda"
        ),
        8: (
            "computar", "librería", "camiseta", "aventura", "balcones", "camarero", "caminata", "campañas", "carteles", "cascabel",
            "cementos", "columnas", "comienza", "completo", "comprado", "consulta", "costuras", "creación", "criatura", "cronista",
            "cuaderno", "cuchillo", "cuidados", "culturas", "dentista", "desayuno", "destinos", "discurso", "división", "economía",
            "edificio", "elegante", "embarazo", "encargos", "encender", "enfermar", "entregar", "escalera", "escritor", "espátula",
            "estación", "estímulo", "fabricar", "familias", "fantasma", "festival", "formatos", "fórmulas", "galaxias", "hospital"
        )
    },
    "en": {
        5: (
            "apple", "bread", "chair", "table", "sweet", "light", "night", "house", "plant", "ocean",
            "river", "stone", "smile", "dance", "music", "sound", "touch", "brain", "cloud", "green",
            "grape", "lemon", "peach", "berry", "spicy", "happy", "angry", "quiet", "noisy", "quick",
            "slow", "later", "after", "equal", "solid", "dream", "train", "plane", "earth", "world",
            "water", "blood", "heart", "metal", "white", "black", "brown", "color", "price", "faith"
        ),
        6: (
            "animal", "bridge", "camera", "school", "summer", "winter", "friend", "people", "planet", "silver",
            "golden", "fabric", "window", "garden", "forest", "stream", "yellow", "purple", "orange", "little",
            "second", "number", "letter", "simple", "random", "chance", "throat", "mother", "monday", "friday",
            "august", "thirty", "church", "street", "castle", "market", "butter", "cheese", "alumni", "artist",
            "author", "beauty", "client", "doctor", "driver", "flight", "guitar", "hammer", "island", "jacket"
        ),
        7: (
            "airport", "balance", "another", "between", "because", "without", "teacher", "student", "picture", "country",
            "capital", "battery", "machine", "article", "average", "biscuit", "cabinet", "caramel", "carpets", "central",
            "college", "concert", "connect", "control", "correct", "counter", "current", "despite", "diamond", "digital",
            "economy", "exactly", "factory", "freedom", "furnace", "gallery", "general", "harvest", "history", "imagine",
            "journey", "justice", "kitchen", "library", "message", "morning", "organic", "patient", "quality", "science"
        ),
        8: (
            "building", "computer", "language", "mountain", "airplane", "elephant", "director", "composer", "designer", "children",
            "criminal", "decision", "delivery", "disaster", "distance", "festival", "football", "function", "geometry", "hardware",
            "internet", "magazine", "movement", "painting", "possible", "pressure", "province", "resource", "schedule", "shoulder",
            "software", "solution", "strategy", "struggle", "sunshine", "tomorrow", "training", "vacation", "variable", "villager",
            "wildlife", "calendar", "ceremony", "customer", "database", "graduate", "hospital", "identity", "material", "original"
        )
    },
    "pt": {
        5: (
            "livro", "prato", "canto", "verde", "noite", "praia", "amigo", "fruta", "marca", "cesta",
            "campo", "feliz", "fácil", "pente", "carro", "certo", "claro", "costa", "corpo", "dente",
            "dores", "festa", "floco", "gasto", "gente", "grito", "homem", "horas", "jogos", "leite",
            "lenha", "livre", "meias", "mesas", "metas", "motor", "navio", "nuvem", "olhar", "outra",
            "palma", "papel", "peixe", "perda", "perto", "pilha", "ponto", "porta", "roupa", "terra"
        ),
        6: (
            "cidade", "janela", "animal", "amigos", "amigas", "beijos", "camada", "camisa", "campos", "caneta",
            "carros", "cereja", "chaves", "chuvas", "coisas", "colher", "correu", "corais", "corpos", "correr",
            "doente", "escola", "estado", "etapas", "febril", "feiras", "ferida", "férias", "formar", "garras",
            "gestão", "grande", "idioma", "início", "jardim", "letras", "livros", "macaco", "médico", "melhor",
            "moreno", "móveis", "mulher", "nativo", "nuvens", "ombros", "ordens", "outono", "parede", "pedido"
        ),
        7: (
            "amarelo", "sistema", "coração", "garrafa", "meninas", "meninos", "amostra", "andando", "armazém", "arquivo",
            "bairros", "barulho", "beirada", "belezas", "botinas", "brancas", "brindes", "cabeças", "caderno", "cálculo",
            "caminho", "canções", "carinho", "carpete", "casacos", "castelo", "cimento", "círculo", "clínica", "comidas",
            "compras", "costela", "cultura", "criança", "cuidado", "debates", "defeito", "delícia", "detalhe", "enfermo",
            "enxoval", "escadas", "esperar", "estágio", "estrada", "família", "fazenda", "fechado", "feriado", "formiga"
        ),
        8: (
            "computar", "montanha", "abacaxis", "abacates", "algodões", "amendoim", "aplicado", "aprender", "banheira", "barbeiro",
            "barreira", "batizada", "camiseta", "camisola", "campanha", "campeões", "carreira", "carteira", "cenários", "chiclete",
            "cítricos", "colheita", "colônias", "combinar", "comércio", "compasso", "composta", "conceito", "condutor", "conjunto",
            "conserto", "consulta", "controle", "cozinhar", "crescerá", "cristais", "cruzeiro", "depósito", "desenhos", "desenhar",
            "digestão", "eleições", "empanado", "empresas", "endereço", "enfeites", "engrenar", "esmaltes", "espelhos", "estantes",
            "estrelas", "famílias", "ferrolho", "foguetes", "formigas", "formatos", "formosos", "fragatas", "fraturas", "garrafas",
            "geleiras", "gramados", "guardado", "hóspedes", "infância", "instalar", "lavouras", "limonada", "maçaneta", "madeiras",
            "manteiga", "mariscos", "mecânica", "melancia", "mercados", "mexerica", "montagem", "moradias", "musicais", "nascente",
            "negócios", "nervosos", "notícias", "operador", "orquídea", "paciente", "padeiros", "paisagem", "parreira", "passagem",
            "pastores", "patinete", "pedreira", "pelicano", "pequenas", "pesquiso", "pinturas", "plantios", "poluição", "projetos"
        )
    }
}
...
# NUEVA FUNCIÓN: colorear_intento
